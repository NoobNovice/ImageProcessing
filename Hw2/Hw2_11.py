...
if __name__ == '__main__':
    ...
    print("\nFind amplitude and save in to amplitude21.pgm")
    amp = get_amplitude(G)
    save2pgm(amp,dir_path + "/Image/amplitude21.pgm")
    image = cv2.imread(dir_path + "/Image/amplitude21.pgm",0)
    cv2.imshow('image',image)
    cv2.waitKey(0)

    print("\nFind phase spectra and save in to phase21.pgm")
    phase = get_phase(G)
    ...
    g = invert_fourier(G,F_invert)
    save2pgm(g,dir_path + "/Image/restoreCross.pgm")
